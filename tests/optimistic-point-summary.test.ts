  ...
  it("keeps legacy needs-attention actions additive while automatic retry recovers them", () => {
    const summary = applyPendingPointActions(
      ...
      [
        ...
        { id: "undo-reward", parentId: "parent", childId: "child", kind: "undo_reward", eventId: "reward-event", pointDelta: 4, createdAt: "2026-08-09T10:02:30Z", status: "queued" },
    ...
    expect(summary).toEqual({ balance: 110, receivedThisWeek: 106, redeemedThisWeek: 2 });
  });
});
